...
{
    public sealed class LosAlamosQueenModel : ChessItemModelBase
    {
        public LosAlamosQueenModel(ChessSide side, BoardPosition pos, int steps = 0) : base(side, (byte)LosAlamosChessItemType.queen, pos, steps) { }
