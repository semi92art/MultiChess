...
{
    public sealed class ChaturangaQueenModel : ChessItemModelBase
    {
        public ChaturangaQueenModel(ChessSide side, BoardPosition pos, int steps = 0) : base(side, (byte)ChaturangaChessItemType.queen, pos, steps) { }
